...
//    vtkImageImport *volume = vtkImageImport::New();
    volume=v;
//    filepath="D:\\TransformCT\\volume1C";
    ...
    meta->SetAttributeValue(vtkDICOMTag(0x0018, 0x5100), Patientsetup.toStdString().c_str());
...
//            fprintf(fp1,"	</Dicom>\n");
//            fprintf(fp1,"		<header No=\"57\" Elem=\"0x5100\" Group=\"0x0018\" VRKey=\"IS\">%d</header>\n",IIma);
//            fprintf(fp1,"		<!--Patient pos-->\n");
//            fprintf(fp1,"</extraHeaders>\n");
//            fclose(fp1);
//        }
//}
